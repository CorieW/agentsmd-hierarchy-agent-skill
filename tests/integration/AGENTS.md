...
- `e2e.test.mjs`: Exercises the public CLI and bundled script entrypoints end to end, including scaffold, sync, validation, install, and overwrite-protection flows.
